...
namespace Pobs.Tests.Integration.Notifications
{
    public class PostWatchCommentTests : IDisposable
    {
        ...
        public async Task Add_ShouldAddWatch()
        {
            ...
            {
                Method = "Add",
                Type = WatchType.Comment.ToString(),
                Id = _comment.Id,
            };
            ...
            using (var client = server.CreateClient())
            {
                ...
                Assert.Equal(WatchType.Comment.ToString(), watchModel.Type);
                Assert.Equal($"{_comment.Answer.Question.Id}|{_comment.Answer.Id}|{_comment.Id}", watchModel.Identifier);
        ...
        [Fact]
        public async Task Add_UnknownCommentId_ShouldReturnBadRequest()
        {
            var payload = new WatchFormModel
            {
                Method = "Add",
